...
class simmodels(object):
    ...
    def train(self, train_data, dev_data=None):
        ...
        train_dataset = simdatasets(train_data['content'],
                                    train_data['entity'],
                                    train_data['label'],
    ...
    def evaluate(self, eval_data):
        eval_dataset = simdatasets(eval_data['content'],
                                   eval_data['query'],
                                   eval_data['label'],
        ...
        for batch in tqdm(eval_dataloader, total=len(eval_dataloader), desc='Validing...'):
            self.model.eval()
    ...
    def predict(self, test_data):
        test_dataset = simdatasets(test_data['content'],
                                   test_data['entity'],
                                   [None] * len(test_data['content']),
                                   self.toknizer, args.max_seq_len)
